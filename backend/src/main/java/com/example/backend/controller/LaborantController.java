...
import com.example.backend.service.LaborantServiceImpl;
...
public class LaborantController {
    ...
    @PostMapping("/getAllReportsWithFilters")
    public List<ReportGetDto> getAllReportsWithFilters(@RequestBody FilterDto filterDto){ return laborantService.getAllReports(filterDto);}
